...
if len(tickers) < 1:
    ...
    for i in range(num_assets):
        weight = st.sidebar.slider(f"Weight for {tickers[i]}", 0.0, 1.0, 1.0 / num_assets, step=0.01,
    ...
    # Plot Impact of Correlation on Portfolio Risk
    plt.figure(figsize=(10, 5))
    plt.plot(correlations, portfolio_volatilities, label="Portfolio Risk")
    plt.title("Impact of Correlation on Portfolio Risk")
