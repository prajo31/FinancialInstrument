...
def main():
    ...
    # Display definitions on the left side
    st.sidebar.markdown("### Help")
    st.sidebar.markdown("**Future Value:** Calculates how much a present amount will grow over time.")
    st.sidebar.markdown("**Present Value:** Determines the current worth of a future amount.")
    st.sidebar.markdown("**Annuities:** A series of equal payments made at regular intervals.")
